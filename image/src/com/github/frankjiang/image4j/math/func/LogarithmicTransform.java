 ...
 * @version 1.0.0
 */
public class LogarithmicTransform implements Transform
{
	/**
	 ...
	 */
	public LogarithmicTransform(double c, double b)
	{
		this.c = c;
		this.b = b;
	}
	...
	{
		return new InvertedLogarithmicTransform(this.c, this.b);
	}
	...
	public Properties getProperties()
	{
		...
		p.put(LogarithmicTransform.PARAM_C, this.c);
		p.put(LogarithmicTransform.PARAM_B, this.b);
		return p;
	}
	...
	{
		Object obj = null;
		obj = p.get(LogarithmicTransform.PARAM_C);
		if (obj != null && obj instanceof Number)
			this.c = ((Number) obj).doubleValue();
		obj = p.get(LogarithmicTransform.PARAM_B);
		if (obj != null && obj instanceof Number)
	...
	{
		return String.format("s = %f*log(1+r)%+f", this.c, this.b);//$NON-NLS-1$
	}
	...
	{
		return this.c * FastMath.log1p(r) + this.b;
	}
}
